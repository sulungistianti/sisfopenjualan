...
Class Transaksi extends CI_Controller{
    ...
    public function laporan()
    {
        ...
        $pdf->SetX(4);
        $pdf->MultiCell(19.5,0.5,'Toko SulungIstianti',0,'L');
        $pdf->SetX(4);
        $pdf->MultiCell(19.5,0.5,'Telpon : 08988767789876',0,'L');
        $pdf->SetFont('Arial','B',10);
        $pdf->SetX(4);
        $pdf->MultiCell(19.5,0.5,'JL. Gajah Mada',0,'L');
        $pdf->SetX(4);
        $pdf->MultiCell(19.5,0.5,' email : sulungistianti@gmail.com',0,'L');
